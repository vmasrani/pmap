...
# dependencies = ["tqdm"]
# ///
"""Benchmark: tqdm.contrib.concurrent — process_map / thread_map.
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("tqdm.contrib.concurrent — process_map")
    print("=" * 60)
    t0 = time.perf_counter()
    results = process_map(price_option, seeds, max_workers=8, desc="MC pricing")
