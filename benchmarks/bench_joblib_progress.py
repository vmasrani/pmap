...
# dependencies = ["joblib", "joblib-progress"]
# ///
"""Benchmark: joblib-progress — Rich progress bar wrapper for joblib.Parallel.
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("joblib-progress — Rich progress bar on joblib.Parallel")
    print("=" * 60)
    t0 = time.perf_counter()
    with joblib_progress("MC pricing", total=len(seeds)):
        results = Parallel(n_jobs=8)(delayed(price_option)(s) for s in seeds)
